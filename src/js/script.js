...
const text = "TE DESEJO UM FELIZ NATAL E BOAS FESTAS 🎄🎅🏻";
...
function typeWriter() {
  if (i < text.length) {
    ...
    // Quando terminar de digitar, mostrar o botão
    revealButton.classList.remove("hidden");
  }
}

// Quando o botão for clicado, revelar a mensagem
revealButton.addEventListener("click", function () {
  hiddenMessage.classList.remove("hidden"); // Revela a mensagem
  revealButton.classList.add("hidden"); // Esconde o botão após o clique
});
